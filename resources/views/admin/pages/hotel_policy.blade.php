...
@section('title', 'ADMIN - Pages > Hotel Policy')
...
<div id="content" class="bg-light-gray">
    <div class="row">
        <div class="col"><p>HOTEL POLICY PAGE</p></div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card white card-light">
                <div class="head">
                    <h6 class="text-blue-dark text-uppercase">HOTEL POLICY</h6>
                    <hr>
                </div>
                <div class="body">
                    {!! $sub->hotel_policy !!}
        ...
        <div class="modal-content">
            {!! Form::open(['id' => 'sub-form', 'url' => url('/').'/admin/pages/update-sub/'.$sub->id, 'role' => 'form', 'data-toggle' => 'validator']) !!}
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">Edit Hotel Policy</h5>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <textarea class="form-control" id="summernote" name="description" rows="10" required="required">{!! $sub->hotel_policy !!}</textarea>
