...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! url('/') !!}/assets/admin/css/bootstrap_datetimepicker/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" type="text/css" href="{!! url('/') !!}/assets/admin/css/cropper/cropper.css">
...
<script type="text/javascript" src="{!! url('/') !!}/assets/admin/js/moment/moment.js"></script>
<script type="text/javascript" src="{!! url('/') !!}/assets/admin/js/bootstrap_datetimepicker/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="{!! url('/') !!}/assets/admin/js/cropper/cropper.min.js"></script>
