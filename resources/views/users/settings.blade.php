                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><b>
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                                        {!! Form::text('phone_number', Auth::user()->phone_number, ['class' => 'form-control', 'id' => 'phone_number', 'placeholder' => 'Enter Phone Number', 'pattern' => '^([0-9+]{1,2})?\(?[0-9]{3}\)?[.-]?[0-9]{3}[.-]?[0-9]{4,5}$', 'required' => 'required']) !!}
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </b></td>
                        ...
                        <tr>
                            ...
                            <td><b>
                                <div class="form-group">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                                        {!! Form::text('city', Auth::user()->city, ['class' => 'form-control', 'id' => 'city', 'placeholder' => 'Enter City', 'required' => 'required']) !!}
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </b></td>
                        ...
                        <tr>
                            ...
                            <td><b><div class="form-group">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                                        {!! Form::text('province', Auth::user()->province, ['class' => 'form-control', 'id' => 'province', 'placeholder' => 'Enter Province', 'required' => 'required']) !!}
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div></b></td>
                        </tr>
